...
func (x *ObjFieldDao) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
type ObjFieldDaoList struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Objfields []*ObjFieldDao `protobuf:"bytes,1,rep,name=objfields,proto3" json:"objfields,omitempty"`
}

func (x *ObjFieldDaoList) Reset() {
	*x = ObjFieldDaoList{}
	if protoimpl.UnsafeEnabled {
...
func (x *ObjFieldDaoList) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ObjFieldDaoList) ProtoMessage() {}

func (x *ObjFieldDaoList) ProtoReflect() protoreflect.Message {
	mi := &file_protos_metadata_model_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ObjFieldDaoList.ProtoReflect.Descriptor instead.
func (*ObjFieldDaoList) Descriptor() ([]byte, []int) {
	return file_protos_metadata_model_proto_rawDescGZIP(), []int{4}
}

func (x *ObjFieldDaoList) GetObjfields() []*ObjFieldDao {
	if x != nil {
		return x.Objfields
	}
	return nil
...
var file_protos_metadata_model_proto_rawDesc = []byte{
	...
	0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x46, 0x0a, 0x0f, 0x4f, 0x62, 0x6a, 0x46,
	0x69, 0x65, 0x6c, 0x64, 0x44, 0x61, 0x6f, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x33, 0x0a, 0x09, 0x6f,
	0x62, 0x6a, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x15,
	0x2e, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x4f, 0x62, 0x6a, 0x46, 0x69, 0x65,
	0x6c, 0x64, 0x44, 0x61, 0x6f, 0x52, 0x09, 0x6f, 0x62, 0x6a, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x73,
	...
	0x65, 0x64, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x5f, 0x67, 0x65, 0x6e, 0x2f, 0x6d, 0x65,
...
var file_protos_metadata_model_proto_goTypes = []interface{}{
	...
	(*ObjFieldDaoList)(nil), // 6: metadata.ObjFieldDaoList
...
var file_protos_metadata_model_proto_depIdxs = []int32{
	...
	5, // 5: metadata.ObjFieldDaoList.objfields:type_name -> metadata.ObjFieldDao
