...
type QueryUserRecordOption struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	UserId        int32       `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	ForeignIdList []int32     `protobuf:"varint,2,rep,packed,name=foreign_id_list,json=foreignIdList,proto3" json:"foreign_id_list,omitempty"`
	OrderByList   []*OrderBy  `protobuf:"bytes,3,rep,name=order_by_list,json=orderByList,proto3" json:"order_by_list,omitempty"`
	PageOption    *PageOption `protobuf:"bytes,4,opt,name=page_option,json=pageOption,proto3" json:"page_option,omitempty"`
}

func (x *QueryUserRecordOption) Reset() {
	*x = QueryUserRecordOption{}
	if protoimpl.UnsafeEnabled {
...
func (x *QueryUserRecordOption) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryUserRecordOption) ProtoMessage() {}

func (x *QueryUserRecordOption) ProtoReflect() protoreflect.Message {
	mi := &file_protos_admin_model_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use QueryUserRecordOption.ProtoReflect.Descriptor instead.
func (*QueryUserRecordOption) Descriptor() ([]byte, []int) {
	return file_protos_admin_model_proto_rawDescGZIP(), []int{4}
}

func (x *QueryUserRecordOption) GetUserId() int32 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *QueryUserRecordOption) GetForeignIdList() []int32 {
	if x != nil {
...
func (x *QueryUserRecordOption) GetOrderByList() []*OrderBy {
	if x != nil {
...
func (x *QueryUserRecordOption) GetPageOption() *PageOption {
	if x != nil {
		return x.PageOption
	}
	return nil
...
var file_protos_admin_model_proto_rawDesc = []byte{
	...
	0x22, 0xc0, 0x01, 0x0a, 0x15, 0x51, 0x75, 0x65, 0x72, 0x79, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65,
	0x63, 0x6f, 0x72, 0x64, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x17, 0x0a, 0x07, 0x75, 0x73,
	...
	0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x05, 0x52, 0x0d, 0x66, 0x6f,
	0x72, 0x65, 0x69, 0x67, 0x6e, 0x49, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x32, 0x0a, 0x0d, 0x6f,
	0x72, 0x64, 0x65, 0x72, 0x5f, 0x62, 0x79, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x03, 0x20, 0x03,
	...
	0x32, 0x0a, 0x0b, 0x70, 0x61, 0x67, 0x65, 0x5f, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x04,
...
var file_protos_admin_model_proto_goTypes = []interface{}{
	...
	(*QueryUserRecordOption)(nil), // 5: admin.QueryUserRecordOption
...
var file_protos_admin_model_proto_depIdxs = []int32{
	...
	3, // 2: admin.QueryUserRecordOption.order_by_list:type_name -> admin.OrderBy
	4, // 3: admin.QueryUserRecordOption.page_option:type_name -> admin.PageOption
...
func file_protos_admin_model_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_protos_admin_model_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryUserRecordOption); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
