...
var file_protos_faas_service_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xd5, 0x04, 0x0a, 0x04, 0x46, 0x61, 0x61,
...
var file_protos_faas_service_proto_goTypes = []interface{}{
	...
	(*common.DynamicCallReply)(nil),   // 8: common.DynamicCallReply
	(*CreateFaasTaskReply)(nil),       // 9: faas.CreateFaasTaskReply
	(*GetFaasTaskByPageReply)(nil),    // 10: faas.GetFaasTaskByPageReply
	(*GetFaasTaskByIDReply)(nil),      // 11: faas.GetFaasTaskByIDReply
	(*UpdateFaasTaskByIDReply)(nil),   // 12: faas.UpdateFaasTaskByIDReply
	(*RunTaskReply)(nil),              // 13: faas.RunTaskReply
	(*HttpCallTaskReply)(nil),         // 14: faas.HttpCallTaskReply
	(*TestRunCodeReply)(nil),          // 15: faas.TestRunCodeReply
}
var file_protos_faas_service_proto_depIdxs = []int32{
	...
	8,  // 8: faas.Faas.DynamicCall:output_type -> common.DynamicCallReply
	9,  // 9: faas.Faas.CreateFaasTask:output_type -> faas.CreateFaasTaskReply
	10, // 10: faas.Faas.GetFaasTaskByPage:output_type -> faas.GetFaasTaskByPageReply
	11, // 11: faas.Faas.GetFaasTaskByID:output_type -> faas.GetFaasTaskByIDReply
	12, // 12: faas.Faas.UpdateFaasTaskByID:output_type -> faas.UpdateFaasTaskByIDReply
	13, // 13: faas.Faas.RunTask:output_type -> faas.RunTaskReply
	14, // 14: faas.Faas.HttpCallTask:output_type -> faas.HttpCallTaskReply
	15, // 15: faas.Faas.TestRunCode:output_type -> faas.TestRunCodeReply
