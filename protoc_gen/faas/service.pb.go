...
var file_protos_faas_service_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x92, 0x04, 0x0a, 0x04, 0x46, 0x61, 0x61,
	...
	0x6c, 0x6c, 0x54, 0x61, 0x73, 0x6b, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x30, 0x5a,
	0x2e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x59, 0x6f, 0x73, 0x6f,
	0x72, 0x61, 0x62, 0x6c, 0x65, 0x2f, 0x6d, 0x73, 0x2d, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64, 0x2f,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x5f, 0x67, 0x65, 0x6e, 0x2f, 0x66, 0x61, 0x61, 0x73, 0x62,
...
var file_protos_faas_service_proto_goTypes = []interface{}{
	...
	(*common.DynamicCallReply)(nil),   // 7: common.DynamicCallReply
	(*CreateFaasTaskReply)(nil),       // 8: faas.CreateFaasTaskReply
	(*GetFaasTaskByPageReply)(nil),    // 9: faas.GetFaasTaskByPageReply
	(*GetFaasTaskByIDReply)(nil),      // 10: faas.GetFaasTaskByIDReply
	(*UpdateFaasTaskByIDReply)(nil),   // 11: faas.UpdateFaasTaskByIDReply
	(*RunTaskReply)(nil),              // 12: faas.RunTaskReply
	(*HttpCallTaskReply)(nil),         // 13: faas.HttpCallTaskReply
}
var file_protos_faas_service_proto_depIdxs = []int32{
	...
	7,  // 7: faas.Faas.DynamicCall:output_type -> common.DynamicCallReply
	8,  // 8: faas.Faas.CreateFaasTask:output_type -> faas.CreateFaasTaskReply
	9,  // 9: faas.Faas.GetFaasTaskByPage:output_type -> faas.GetFaasTaskByPageReply
	10, // 10: faas.Faas.GetFaasTaskByID:output_type -> faas.GetFaasTaskByIDReply
	11, // 11: faas.Faas.UpdateFaasTaskByID:output_type -> faas.UpdateFaasTaskByIDReply
	12, // 12: faas.Faas.RunTask:output_type -> faas.RunTaskReply
	13, // 13: faas.Faas.HttpCallTask:output_type -> faas.HttpCallTaskReply
